...
if (!function_exists('mb_str_pad')) {
     ...
     * @param string|null $encoding The encoding to use, defaults to null.
     *
     * @see https://gist.github.com/rquadling/c9ff12755fc412a6f0d38f6ac0d24fb1
     *
     * @return string A padded multibyte string.
     */
    function mb_str_pad($input, $length, $padding = ' ', $padType = STR_PAD_RIGHT, $encoding = null)
    {
        $result = $input;
